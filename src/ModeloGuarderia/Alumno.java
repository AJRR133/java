...
public String toString() {
	return "Alumno [id=" + id + ", nombre=" + nombre + ", apellidos=" + apellidos + ", edad=" + edad + ", telefono="
			+ telefono + ", alergias=" + alergias + ", autorizaImagenes=" + autorizaImagenes + ", maestro=" + maestro
			+ "]";
}
public Alumno(int id, String nombre, String apellidos, int edad, String telefono, List<String> alergias,
